...
class mainWindow(QtGui.QMainWindow):
    ...
    def retranslateUi(self):
        self.setWindowTitle(_translate("mainWindow", "saccadeApp", None))
...
class formFileHome(QtGui.QWidget):
    ...
    def retranslateUi(self):
        ...
        self.lblTitle.setText(_translate("formFileHome", "saccadeApp", None))
...
class formFileConfig(QtGui.QWidget):
    ...
    def openMonitorCenter(self):
        ...
        if isClosed:
            ...
            command = u'python ../saccadeApp/monitorCenter.py'
