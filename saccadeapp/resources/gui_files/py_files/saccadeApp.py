...
class Ui_dlg_saccadeapp(object):
    def setupUi(self, dlg_saccadeapp):
        dlg_saccadeapp.setObjectName(_fromUtf8("dlg_saccadeapp"))
        dlg_saccadeapp.resize(530, 350)
        dlg_saccadeapp.setMinimumSize(QtCore.QSize(530, 350))
        dlg_saccadeapp.setMaximumSize(QtCore.QSize(530, 850))
        self.vly_01 = QtGui.QWidget(dlg_saccadeapp)
        ...
        self.pbt_configuration_copy.setObjectName(_fromUtf8("pbt_configuration_copy"))
        ...
        dlg_saccadeapp.setCentralWidget(self.vly_01)
        self.mbr_menu = QtGui.QMenuBar(dlg_saccadeapp)
        ...
        dlg_saccadeapp.setMenuBar(self.mbr_menu)
        self.mac_exit = QtGui.QAction(dlg_saccadeapp)
        self.mac_exit.setObjectName(_fromUtf8("mac_exit"))
        self.mac_documentation = QtGui.QAction(dlg_saccadeapp)
        self.mac_documentation.setObjectName(_fromUtf8("mac_documentation"))
        self.mac_about = QtGui.QAction(dlg_saccadeapp)
        self.mac_about.setObjectName(_fromUtf8("mac_about"))
        self.actionSome_shit = QtGui.QAction(dlg_saccadeapp)
        ...
        self.retranslateUi(dlg_saccadeapp)
    ...
    def retranslateUi(self, dlg_saccadeapp):
        ...
        self.pbt_configuration_copy.setText(_translate("dlg_saccadeapp", "Copy", None))
