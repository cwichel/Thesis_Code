...
class Ui_dlg_test(object):
    def setupUi(self, dlg_test):
        dlg_test.setObjectName(_fromUtf8("dlg_test"))
        dlg_test.resize(530, 500)
        dlg_test.setMinimumSize(QtCore.QSize(530, 380))
        dlg_test.setMaximumSize(QtCore.QSize(530, 850))
        self.verticalLayout = QtGui.QVBoxLayout(dlg_test)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.gbx_test = QtGui.QGroupBox(dlg_test)
        ...
        self.gbx_frames = QtGui.QGroupBox(dlg_test)
        ...
        self.pbt_preview = QtGui.QPushButton(dlg_test)
        ...
        self.bbt_save = QtGui.QDialogButtonBox(dlg_test)
        ...
        self.retranslateUi(dlg_test)
        QtCore.QObject.connect(self.bbt_save, QtCore.SIGNAL(_fromUtf8("accepted()")), dlg_test.accept)
        QtCore.QObject.connect(self.bbt_save, QtCore.SIGNAL(_fromUtf8("rejected()")), dlg_test.reject)
        QtCore.QMetaObject.connectSlotsByName(dlg_test)

    def retranslateUi(self, dlg_test):
        dlg_test.setWindowTitle(_translate("dlg_test", "Test", None))
